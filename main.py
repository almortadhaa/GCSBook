...
# البيانات الأساسية من بيئة Render
...
async def help_command(update, context):
    await update.message.reply_text("مرحباً! استخدم /start لبدء الاستعلام عن مستحقاتك.")
...
async def handle_choice(update, context):
    ...
    if query.data == 'know':
        ...
        await query.edit_message_text("عذراً، هذا البوت مخصص للاستعلام برقم وظيفي. حاول العثور عليه أولاً أو تواصل مع الإدارة.")
